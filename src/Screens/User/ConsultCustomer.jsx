      ...
      <div style={{ position: "relative" }}>
        ...
        >
          Legal Advisor
            ...
            <div>
              <p className="firstP">Adv. {data?.lawyer?.fullName || data?.lawyer?.firstName + ' ' + data?.lawyer?.lastName}</p>
              {data?.lawyer?.expertises?.map((d, i)=> (
                  <span key={i} className="secondP">{d +  ', ' || 'null'}</span>
          ...
          >
            ...
            />
            <div style={{ color: "white", fontSize: "14px" }}>{data?.lawyer?.rating}</div>
          </div>
        </div>
              </div>
            </div>
          ...
          <button style={{ fontSize: "20px", fontWeight:700 , width:"120px", border:"none" }}>Consult</button>
          ...
          <div className="consult">
            ...
            <i class="fa-solid fa-video"></i>
              <p>Consultancy Cost <span style={{marginLeft:"10px"}}>@{data?.lawyer?.consultancyCost}/min</span></p>
            </div>
            
          </div>
          <div className="consult">
            <div style={{fontSize:"18px" , padding:"12px 0px", fontWeight:700}}>Status (Active)</div>
            <div>
