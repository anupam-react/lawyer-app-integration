    ...
    <>
      ...
      <div className="UserSideBar">
        ...
        <div className="center">
          ...
          <img src={UserInfo?.image} alt="" onClick={()=> navigate('/laywer-profile')} style={{width:"120px" , cursor:"pointer", height:"120px" , borderRadius:'50%' ,}}/>
          <div style={{ position: "relative" }}>
                       ...
                       <div
                          ...
                          >
                            ...
                            />
                            <div style={{ color: "#0F2C64", fontWeight:700 }}>{UserInfo?.rating}</div>
                          </div>
          </div>
